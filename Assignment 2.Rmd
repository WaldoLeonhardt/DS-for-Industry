...
We can add a count of words per sentence and list the sentences where the same word occurs the most frequent.
...
* Our activation function for the hidden layer will be ReLU (rectified linear unit where any negative values will be made zero).
