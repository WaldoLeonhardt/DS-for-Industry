...
* Ramaphosa (ID = 5), only 4 predictions were correct. This is also expected as only 2.9% of all words were assosiated with him.
...
* deKlerk (ID = 0), we now have 6 correct prediction compared with 1 before.
* Ramaphosa (ID = 5), we now also have 6 correct prediction compared with 4 before.
...
From the above random tests, we have 3 correct and 2 incorrect predictions which is in line with our 59.2% accuracy for the model.
